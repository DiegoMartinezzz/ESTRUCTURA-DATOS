#Representar un grafo no dirigido y recorrerlo en anchura (BFS) y profundidad (DFS).
#Explicación:
#• BFS (Breadth-First Search): explora primero los vecinos más cercanos (usa cola).
